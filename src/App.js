...
export default function App() {
    ...
    function Random() {
        ...
        for (let i = 0; i < 3; i++) { // Fill the array 
        ...
        <div className="container mx-auto">
            <div className="flex flex-col justify-center items-center h-screen">
                <div className='relative mb-3'>
                    ...
                    {randomChars && (
                        <a title="Copy to clipboard" className='absolute copy' onClick={copyToClipboard}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="black" className="bi bi-clipboard" viewBox="0 0 16 16">
